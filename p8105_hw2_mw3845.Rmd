...
- What proportion of station entrances / exits without vending allow entrance?
  ...
  _`r mean(filter(subway_df, vending == 'NO')$entry)*100`% of station entrances / exits without vending allow entrance. Note: Here we are not using the unique station data because a station might have multiple entrances / exits that the entry w/o vending could happen._
