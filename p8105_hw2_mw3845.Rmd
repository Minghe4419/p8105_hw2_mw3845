...
```
###### Merge datasets
We merge the 3 dataframes and then organize variables in an order that series and episode of corresponding baker, the bakers personal info, and then their performence in the show.
```{r merge_data}
